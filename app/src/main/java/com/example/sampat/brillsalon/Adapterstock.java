...
public class Adapterstock extends RecyclerView.Adapter<Adapterstock.Re>{

    RequestQueue requestQueue;
    private ArrayList<Productstock> productList;
    private Context context;
    public Adapterstock(Context context,ArrayList<Productstock> productlist ) {
    ...
    public Adapterstock.Re onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inf = LayoutInflater.from(parent.getContext());
        View view = inf.inflate(R.layout.liststock, parent, false);
        return new Adapterstock.Re(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Re holder, final int position) {
        final  Productstock product = productList.get(position);
        holder.sh.setText(product.getBname());
        holder.nu.setText(product.getPname());
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("name",product.getBname());
                intent.putExtra("email",product.getPname());
                intent.putExtra("phone",product.getQun());
                intent.putExtra("prize",product.getPrize());
    ...
    public void Filter(ArrayList<Productstock> newList)
    {
    ...
    public static class Re extends RecyclerView.ViewHolder {
        ...
        public Re(View itemView) {
            ...
            nu = itemView.findViewById(R.id.n);
    ...
    {
        String url="http://brilltechno.com//salon/android/deletestock.php?id="+uid+"";
