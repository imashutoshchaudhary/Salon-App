...
public class Editoffer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Update Offers");
    ...
    public void ClientRecordUpdate(String ClientNameHolder1, String ClientEmailHolder1, String ClientPhoneHolder1) {
        ...
        String url = "http://brilltechno.com//salon/android/updateoffer.php?sid=" + Idholder + "?name=" + ClientNameHolder1 + "&amount=" + ClientEmailHolder1 + "&coupon_code=" + ClientPhoneHolder1+"&salon_id="+sharedPreferences.getString("id", "");;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent n = new Intent(Editoffer.this, Offers.class);
                startActivity(n);
                finish();
        }
