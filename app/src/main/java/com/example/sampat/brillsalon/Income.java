...
public class Income extends AppCompatActivity {
    ...
    public void onLoginFailed() {
        Toast.makeText(Income.this, "Fill all entries", Toast.LENGTH_LONG).show();
    ...
    private void saveRequest() {
        ...
        String url1 = URL_SAVE + "?phone="+q+  "&services=" + d+"&price="+p+"&date_of_birth="+b+"&salon_id="+  sharedPreferences.getString("id", "");
        ;
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url1,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        Toast.makeText(Income.this, response, Toast.LENGTH_LONG).show();
                        dis.setText("");
                        qn.setText("");
                        pz.setText("");
                        Birthday.setText("");
