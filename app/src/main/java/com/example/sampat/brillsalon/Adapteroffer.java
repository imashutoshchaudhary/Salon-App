...
public class Adapteroffer extends RecyclerView.Adapter<Adapteroffer.Re> {
    RequestQueue requestQueue;
    private ArrayList<Productoffer> productList;
    private Context context;
    public Adapteroffer(Context context,ArrayList<Productoffer> productlist ) {
        this.context=context;
        this.productList = productlist;
    }
    @Override
    public Adapteroffer.Re onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inf = LayoutInflater.from(parent.getContext());
        View view = inf.inflate(R.layout.listoffer, parent, false);
        return new Adapteroffer.Re(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapteroffer.Re holder, final int position) {
        final  Productoffer product = productList.get(position);
        holder.sh.setText(product.getOname());
        holder.nu.setText(product.getOamont());
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("name",product.getOname());
                intent.putExtra("email",product.getOamont());
                intent.putExtra("phone",product.getOcoupn());
    ...
    public void Filter(ArrayList<Productoffer> newList)
    {
    ...
    {
        String url="http://brilltechno.com//salon/android/deleteoffer.php?id="+uid+"";
