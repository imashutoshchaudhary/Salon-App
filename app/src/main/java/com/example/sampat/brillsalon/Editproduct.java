...
public class Editproduct extends AppCompatActivity {
    ...
    public void ClientRecordUpdate(String ClientNameHolder1, String ClientEmailHolder1)
    {
        ...
        String url="http://brilltechno.com//salon/android/updateproductdata.php?sid="+Idholder+"?name="+ClientNameHolder1+"productprice="+ClientEmailHolder1+"&salon_id="+ sharedPreferences.getString("id", "");
        ;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                Intent n=new Intent(Editproduct.this,Soldproduct.class);
                startActivity(n);
                finish();
        }
